...
const dict: I18nDict = {
  ...
  'notifications.markRead': { ar: 'تحديد كقروء', en: 'Mark as read' },
  'notifications.viewAll': { ar: 'عرض الكل', en: 'View all' },
  'notifications.empty': { ar: 'لا توجد إشعارات جديدة', en: 'No new notifications' },
  'notifications.newEmail': { ar: 'تم إنشاء حساب بريد جديد', en: 'New email account created' },
  'notifications.paymentSuccess': { ar: 'تم الدفع بنجاح', en: 'Payment successful' },
