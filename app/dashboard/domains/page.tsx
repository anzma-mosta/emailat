            ...
            <div className="px-6 py-4 border-b border-[#e6ebf4] dark:border-gray-800">
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                ...
                <div className="sm:col-span-2 flex items-center justify-end gap-2">
                  ...
                  <Button size="sm" onClick={addDomain}>{locale === 'ar' ? 'حفظ' : 'Save'}</Button>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="px-6 py-4 border-b border-[#e6ebf4] dark:border-gray-800">
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                <Input
                  ...
                  placeholder={locale === 'ar' ? 'example.com' : 'example.com'}
                />
                <div className="sm:col-span-3 flex items-center justify-end gap-2">
                  <Button size="sm" variant="outline" onClick={() => setShowConnect(false)}>{locale === 'ar' ? 'إلغاء' : 'Cancel'}</Button>
                  <Button size="sm" onClick={connectDomain}>{locale === 'ar' ? 'حفظ' : 'Save'}</Button>
                </div>
              </div>
            </div>
          )}
                  ...
                  <tr key={d.name} className="hover:bg-background-light/50 dark:hover:bg-gray-800/20 transition-colors">
                    ...
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Button size="sm" variant="outline">
                          <Icon name="renew" className="mr-2" />
                          {t('dashboard.renew')}
                        </Button>
